export const en = {
  ...
  AlphaCash: "AlphaCash",
  AlphaCashBrief:
    "AlphaCash is a safe, simple and fast online loan with a variety of loan products. You can always find a loan product that suits you.",
  PrivacyPolicy:
    "For more information, please see the Privacy Policy and Terms&Conditions.",
  Agree: "Agree",
  Reject: "Reject",
  RateUs: "Rate Us",
  GoodReview:
    "You have completed the application and are reviewing it. The payment will be released after a while. If you think it is good, remember to give it a good review.",
  RepaymentTips: "Repayment Tips",
  RepaymentWords:
    "In order to avoid overdue behavior, you can turn on the repayment reminder, which will remind you to repay the repayment in time on [the day before the due date and the day] and increase the amount",
  NoteSettings:
    "Note: If you need to turn off the reminder, you can turn it off in My/Settings",
  NoOpen: "No Open",
  OpenNow: "Open Now",
  RateNow: "Rate Now",
  ...
  EditNow: "Edit Now",
  AccountErrorMessage:
    "Because your receiving account number is wrong, the payment cannot be made successfully, please edit the receiving account number!",
  IDPhotoErrorMessage:
    "We were unable to verify your identity because your ID photo is blurry, please upload it again so we can verify!",
  FacePhotoErrorMessage:
    "Because your face recognition is blurred, we cannot check your information, please re-face recognition so that we can verify",
  FaceRecognitionNow: "Face Recognition Now",
  ImproveYourPassRate:
    "Please follow the instructions to complete the face recognition action and improve your pass rate!",
  InReview: "In Review",
  ...
  "Kind Tips": "Kind Tips",
  KindTips1:
    "Cooling off period: If you regret applying for a loan,please contact us promptly and repay the principal within24 hours.According to company regulations, we will cancel your loan application for free!",
  KindTips2:
    "Remember to repay the loan in time, if you fail to repay the loan on time, you will be fined according to the  Late Payment Charges rate of 2%/day!",
  KindTips3:
    "Name of Principal Executive Officer for Loan Processing: xxxx  Contact email: xxxxt@xx.com  Address: XXXXXXXX",
  ...
  "Use EasyPaisa for repayment":
    "Use EasyPaisa for repayment, operation instructions Click to view>':'Tips: Use EasyPaisa for repayment, operation instructions Click to view>",
  Tips: "Tips",
  ...
  "information security":
    "The information you fill in is only used for credit evaluation and will never be used for other purposes.We use encryption to ensure your information security!",
  Name: "Name",
  ...
  "CNIC has been bound by others, please re-enter":
    "CNIC has been bound by others, please re-enter",
  ...
  "EasyPaisa Repayment Operation Instructions":
    "%{type} Repayment Operation Instructions",
  "Operating steps": "Operating steps",
  "Log in EasyPaisa Account and then enter Consumer ID":
    "Log in [%{type} Account]>>Click Search and enter [AlphaCash]>> and then enter [Consumer ID]",
