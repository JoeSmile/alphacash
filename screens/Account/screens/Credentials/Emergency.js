...
const EmergencyFormSchema = Yup.object().shape({
  ...
  name1: Yup.string()
    .required('Required'),
  phoneNumber1: Yup.string().matches(/^\d{11}$/, '请输入正确手机号')
    .required('Required'),
  relationship2: Yup.number()
    .required('Required'),
  name2: Yup.string()
    .required('Required'),
  phoneNumber2: Yup.string().matches(/^\d{11}$/, '请输入正确手机号')
        ...
        >
          {({ handleChange, handleBlur, handleSubmit, values, setFieldValue }) => (
            <>
              ...
              <View style={styles.module}>
                <FTextInput name="phoneNumber1" label="Reference Number 1" hintValue="Please enter the number manually" keyboardType="numeric" />
              </View>
              ...
              <View style={styles.module}>
              <FTextInput name="phoneNumber2" label="Reference Number 2" hintValue="Please enter the number manually" keyboardType="numeric" />
              </View>
