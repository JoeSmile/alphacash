...
export default function Repay({navigation, route}) {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* 还款name 和 id */}
      <View style={{paddingHorizontal: 15,paddingVertical: 20, backgroundColor: '#FFFFFF', marginTop: 20, borderRadius: 4}}>
        ...
        <View style={{borderWidth:1, borderColor: '#F4F5F7', marginVertical: 20}}/>
      ...
      {/* Notice */}
       <View style={{marginTop: 20}}>
        ...
        <View style={{
          ...
          <Text style={{color: '#8899AC', fontSize: 12}}>使用 EasyPaisa 进行还款，操作说明 </Text>
          <Pressable onPress={() => {
            navigation.push('RepayDemo', {type: CHANNEL[channel]})
          }}>
            <Text style={{color: '#0825B8', fontSize: 12}}>{`点击查看>>`}</Text>
          </Pressable>
        </View>
      </View>
      </View>

      <FButton onPress={() => navigation.goBack()} title='Submit' style={{bottom: 20}}/>
